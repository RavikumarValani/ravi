...
$table = $installer->getConnection()
    ->newTable($installer->getTable('compile/eav_attribute'))
    ...
    ->addIndex($installer->getIdxName('compile/eav_attribute', array('used_for_sort_by')),
        array('used_for_sort_by'))
    ->addIndex($installer->getIdxName('compile/eav_attribute', array('used_in_product_listing')),
        array('used_in_product_listing'))
    ->addForeignKey($installer->getFkName('compile/eav_attribute', 'attribute_id', 'eav/attribute', 'attribute_id'),
        'attribute_id', $installer->getTable('eav/attribute'), 'attribute_id',
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
    ->setComment('compile EAV Attribute Table');

$query = "ALTER TABLE `compile_varchar` ADD UNIQUE( `attribute_id`, `store_id`, `entity_id`)";
